// components/e-paper/RightArticlePanel.jsx
import React from "react";
import Image from "next/image";

export default function RightArticlePanel({ selectedArticle, selectedPage }) {
  if (!selectedArticle) {
    return (
      <div className="bg-gray-50 rounded-xl p-6 shadow-lg sticky top-4">
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">কোনো নিউজ সিলেক্ট করুন</p>
    ...
    <div className="bg-white rounded-xl shadow-lg overflow-hidden sticky top-4">
      ...
      <div className="px-5 pt-4">
        <span className="inline-block bg-blue-100 text-blue-700 text-xs px-2 py-1 rounded">
          {selectedArticle.category || "জাতীয়"}
        </span>
      </div>
